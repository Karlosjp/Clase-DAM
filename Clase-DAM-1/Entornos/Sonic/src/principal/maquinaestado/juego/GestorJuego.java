...
public class GestorJuego implements EstadoJuego {
	...
	public void dibujar(Graphics g) {
		...
		// DibujoDebug.dibujarString(g, "Salida X = " +
		// ElementosPrincipales.mapa.getPosicionCambio().getX(), 20, 70,
		// Color.red);
		// DibujoDebug.dibujarString(g, "Salida Y = " +
		// ElementosPrincipales.mapa.getPosicionCambio().getY(), 20, 80,
		// Color.red);
		// DibujoDebug.dibujarString(g, "X = " +
		// ElementosPrincipales.jugador.getPosicionXInt(), 20, 50, Color.red);
		// DibujoDebug.dibujarString(g, "Y = " +
		// ElementosPrincipales.jugador.getPosicionYInt(), 20, 60, Color.red);
	}
