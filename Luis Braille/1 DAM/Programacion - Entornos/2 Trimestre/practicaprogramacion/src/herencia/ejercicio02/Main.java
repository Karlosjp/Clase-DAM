...
public class Main {
	...
	public static void main(String[] args) {
		...
		Revista revista1 = new Revista(344, "444555", "Año Cero", 2019);
		Revista revista2 = new Revista(255, "002244", "National Geographic", 2003);
		...
		if(libro2.estaPrestado())
			System.out.println("El libro està prestado");
